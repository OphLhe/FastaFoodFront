    ...
    <>
      <div className="logoAccount">
        <img
          src={imageFastaFood}
          onClick={() => { token ? 
            navigate('/employee/welcome') : navigate('/') }}
        />
      </div>
      ...
      <div className="listAccount">
        <ul className="infoAccount">
          <li>
            <strong>Nom :</strong>{" "}
            <span className="infoEmployee">{employeeInfos.firstName}</span>
          </li>
          <li>
            <strong>Prénom :</strong>{" "}
            <span className="infoEmployee">{employeeInfos.lastName}</span>
          </li>
          <li>
            <strong>Email :</strong>{" "}
            <span className="infoEmployee">{employeeInfos.mail}</span>
          </li>
          <li>
